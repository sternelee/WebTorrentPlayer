...
const dictionaries = {
  en: flatten({
    ...
    torrent: {
      pasteMagnetHint: "Paste magnet link, .torrent URL, or any HTTP download URL",
      supportsMagnet: "Supports magnet links, .torrent URLs, and direct HTTP file downloads.",
      dragToImport: "Release to import .torrent file.",
      invalidInput: "Please enter a magnet link, .torrent URL, or a direct HTTP/HTTPS download URL.",
  ...
  "zh-CN": flatten({
    ...
    torrent: {
      pasteMagnetHint: "粘贴 magnet 链接、.torrent 地址或普通 HTTP 下载链接",
      supportsMagnet: "支持 magnet 链接、.torrent 地址和普通 HTTP 直链下载。",
      dragToImport: "松手即可导入 .torrent 文件。",
      invalidInput: "请输入 magnet 链接、.torrent 地址或 HTTP/HTTPS 直链。",
